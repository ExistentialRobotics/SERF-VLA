...
# Example scripts:
#   bash scripts/train/train_4d_env_robot_feat_map.sh
#   bash scripts/train/train_4d_env_robot_feat_map.sh --task-id task-0026 --batch-size 8 --num-train-steps 40000
