...
#   bash scripts/test/test_4d_env_feat_map.sh --task-id 0026 --checkpoint-path exps/path/to/checkpoint/20000
#   bash scripts/test/test_4d_env_feat_map.sh --logging-tag trial_01 --write-tracking-video true -- eval_instance_ids='[0,1,2]'
...
CHECKPOINT_PATH="exps/pi_serf_behavior_b1k_fast--4d_env_feat_map--50t_lora--task-0021/bs_16--iter_20000/latest"
...
SERVER_LOG="logs/_server/serve_4d_env_feat_map_b1k.log"
EVAL_ARGS=()
...
set +e
"${CONDA_ENV_PYTHON_PATH}" BEHAVIOR-1K/OmniGibson/omnigibson/learning/eval_4d_env_feat_serf_b1k.py \
