...
#   bash scripts/test/test_2d_image.sh --task-id 0026 --checkpoint-path exps/path/to/checkpoint/20000
#   bash scripts/test/test_2d_image.sh --logging-tag trial_01 --write-video false -- eval_instance_ids='[0,1,2]'
...
CHECKPOINT_PATH="checkpoints/exps/pi_behavior_b1k_fast--50t_lora/task_0021--bs_16--iter_40000/2026.03.20_06:29:14/20000"

RECORD_STEP_Q_SCORE=true
WRITE_VIDEO=true
WRITE_THIRD_PERSON_VIDEO=true
SERVER_LOG="logs/_server/serve_b1k.log"
EVAL_ARGS=()
